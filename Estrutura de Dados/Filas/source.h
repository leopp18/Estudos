...
typedef struct {
    Celula *inicio; //remoções
    Celula *fim;    //inserções
} Fila;

void inicializar(Fila *fila) {
    fila->inicio = NULL; //coordena o primeiro elemento inserido, logo o que vai ser removido
    fila->fim = NULL;    //coordena o ultimo elemento inserido
}
